...
The database URL comes from application Settings (Neon in real
environments), so migrations always run against the same datastore the app
uses, and no connection string is committed to the repo.
"""
